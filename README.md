...
<p align="center">
  <img alt="Version" src="https://img.shields.io/badge/version-v0.4.15-blue?style=flat-square">
...
这和一般的 chatbot 式 AI 有本质区别。Chatbot 的交互模型是"一轮一问"，上下文在聊天记录里，关闭就丢。AIASys 的工作区是任务的持久载体，所有中间产物（文件、代码、数据、图表、知识库、图谱）都沉淀在工作区内，对话只是推进任务的一个入口，不是唯一的记忆载体。结果是可回看、可继续、可复用的，不是聊完就散的纯文本流。
...
<p align="center">
  <img src="images/readme/demo-knowledge-graph-exploration-cropped.png" alt="知识图谱实体关系探索" width="820">
</p>
