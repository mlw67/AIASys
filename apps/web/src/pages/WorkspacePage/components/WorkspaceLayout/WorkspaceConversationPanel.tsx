          ...
          {conversations.length === 0 ? (
            ...
            sortedConversations.map((conversation) => {
              ...
              const isSwitchPending =
                conversation.session_id === pendingSwitchSessionId;
              const isSwitchSucceeded =
                conversation.session_id === switchSucceededSessionId;
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem
                          onClick={(event) => {
                            ...
                            setRenameValue(conversation.title || "未命名对话");
                        ...
                        <DropdownMenuItem
                          onClick={(event) => {
                            event.stopPropagation();
                            void onForkConversation(conversation.session_id);
                          }}
                        >
