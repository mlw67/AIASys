...
- **每日自动化会话**：每天新建一条普通会话做工作区巡检
- **工作日晚间会话**：工作日固定时间收口检查
- **每周周报会话**：汇总本周进展与下周计划
- **PaperVault 文献综述**（continuous）：围绕指定研究主题自动检索 PaperVault 论文、生成候选列表与趋势分析、起草综述草稿，并在关键节点暂停等待审核

选择模板后，系统会自动填入推荐的触发类型、会话策略和初始 prompt。用户可以根据具体研究方向修改 prompt 和续推说明。
